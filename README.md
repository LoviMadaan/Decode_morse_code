...
> ## **[DECODE_MORSE_CODE]** :- is a project that enables users to decode Morse code messages into readable text. The tool is built using the Ruby programming language and takes Morse code input AND The program then converts the input into the corresponding ASCII characters and outputs the decoded message.
...
```sh
  cd my-folder
  git clone github.com/LoviMadaan/Decode_morse_code
```
...
- [ ] The program could be improved by adding a graphical user interface (GUI) to make it more user-friendly and accessible to non-technical users.
- [ ] The program could be extended to include a Morse code encoder that allows users to input text and convert it into Morse code.
